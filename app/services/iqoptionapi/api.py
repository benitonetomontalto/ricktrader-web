...
from .ws.chanels.get_balances import *

from .ws.chanels.ssid import Ssid
from .ws.chanels.subscribe import *
from .ws.chanels.unsubscribe import *
from .ws.chanels.setactives import SetActives
from .ws.chanels.candles import GetCandles
from .ws.chanels.buyv2 import Buyv2
from .ws.chanels.buyv3 import *
from .ws.chanels.user import *
...
from .ws.chanels.get_positions import *
...
from .ws.chanels.digital_option import *
from .ws.chanels.api_game_getoptions import *
